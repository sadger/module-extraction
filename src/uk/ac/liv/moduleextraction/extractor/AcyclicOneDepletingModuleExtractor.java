...
public class AcyclicOneDepletingModuleExtractor implements Extractor {
	...
	public AcyclicOneDepletingModuleExtractor(OWLOntology ontology) {
		this(ontology.getLogicalAxioms());
	}

	public AcyclicOneDepletingModuleExtractor(Set<OWLLogicalAxiom> ontology){
